...
class Agent:
    ...
    def show_debug_information(self, current_state, action, reward, next_state, game_over, score):
...
def train():
    ...
    while True:
        ...
        if done:
            ...
            agent.show_debug_information(state_old, final_move, reward, state_new, done, score)
